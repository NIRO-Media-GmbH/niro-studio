"""SFX-Bestand messen (Taxodia-Erklärvideo, 15.09.2026) — Grundlage für die Auswahl des Sound-Designs.

Aufruf: PYTHONDONTWRITEBYTECODE=1 tools/autocut/venv/bin/python _intern/sfx/sfx_analyse.py
Liest _intern/sfx/inventar.json, dekodiert je Datei (pfad_nas, nur lesend) auf 48 kHz Stereo und misst:
...
Nicht gemessen: Intro (Logo-Jingles), Drones, Glitch, Film Burn, DJ Turntable (Vorgabe: nicht verwenden).
Schreibt _intern/sfx/analyse/sfx_metriken.json.
"""
...
OUT = HIER / "analyse"
SR = 48000
BINS = ("SFX/Whoosh/Fast", "SFX/Whoosh/Slow", "SFX/UI", "SFX/Click", "SFX/Riser", "SFX/Impact")
