"""Sprachspur der Kurzfassung normalisieren + Voice Isolation (Taxodia, 15.09.2026).

Aufruf: tools/autocut/venv/bin/python _intern/audio_normalisieren.py [--lesen]

Ziel:   A1 „FX3 Ton" der roh-Timeline aus _intern/autocut/build.json (eigene Timeline dieser Session), Projekt „Taxodia 09.26".
Regel:  True Peak −3 dBTP je Clip, unabhängig (AutoCut-Feedback 04.09.26); in Resolve 21.1 per NormalizeAudioLevel
        (Live-Probe 09.09.: trifft ffmpeg auf ±0,1 dB). Voice Isolation auf der Spur A1 (User 15.09.26).
