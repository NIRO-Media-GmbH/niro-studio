...
variants = [("D (Vorschlag)  LC-709 | Log-Kontrast 1.20 | Sat 1.03", "fit3.json"), ("A  LC-709 | Log-Kontrast 1.15 | Sat 1.08", "fit2.json"), ("B  LC-709 | Log-Kontrast 1.25 | Sat 1.10", "fit_b.json"), ("C  LC-709 TypeA | Kontrast 1.15 | Sat 1.05", "fit_c.json")]
...
luts = {}
TW, TH = 330, 186
spec = [("Ludwig", 2), ("Flammann", 2), ("Hein", 5), ("BR14_C0253", None), ("BR21_C0259", None), ("BR07_C0246", None)]
W = len(variants) * 2 * TW
