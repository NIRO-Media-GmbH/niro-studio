...
def main() -> None:
    ...
    out = {
        ...
        "sperren": sperren,
        "hinweise": [
            "Ziellänge laut User 14.09.2026: 4–5 min. Kurzfassung 15.09.2026: eine Minute kürzer als die Langfassung "
            "(05:33 → ≈ 04:30, ziel_laenge_s 270), alle Kernaussagen bleiben. 24 statt 28 Beats; Langfassung in "
            "_intern/archiv/2026-09-14 Langfassung/.",
            ...
            "„die zwei Besten“ (#20) und Note 1,06 (#21) nur als O-Ton, keine Einblendung (nicht auf der Website).",
            "Titel (#4) und Endcard (#24) sind Grafik-Platzhalter (Motion); B-Roll bleibt leer (Stufe 3 ausgesetzt, "
            "B-Roll kommt nach Freigabe aus der Vorauswahl des Users).",
            "Enge Anschlüsse gegenhören: #16 „Wir haben,“ → „ein Controlling“ (10-Frame-Schnipsel), "
            "#22 „appellieren,“ → „Testen Sie“ (kaum Pause, keine a7 → Punch-in).",
        ],
    }
