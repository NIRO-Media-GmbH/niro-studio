"""Bildlinien der Interview-Setups messen: Rollwinkel + Fluchtpunkte (Taxodia, 15.09.2026).
...
Ergebnis: linien.json + Prüfbilder linien_<clip>.jpg (Senkrechte grün, Waagerechte blau, Maske rot).
"""
...
W, H = 1920, 1080
SENSOR_BREITE_MM = {"FX3": 35.6, "a7MK4": 35.9}
GRUPPE = {"FX3_0222": ("Ludwig", "FX3"), "FX3_0223": ("Flammann", "FX3"), "FX3_0228": ("Hein", "FX3"),
          "a7MK4_20260908_0118": ("Ludwig", "a7_IV"), "a7MK4_20260908_0119": ("Flammann", "a7_IV"), "a7MK4_20260908_0752": ("Hein", "a7_IV")}
