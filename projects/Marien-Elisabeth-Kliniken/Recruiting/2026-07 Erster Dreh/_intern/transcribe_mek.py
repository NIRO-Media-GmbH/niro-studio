"""MEK Recruiting — selektive Transkription der gesprochenen Parts.

Nur FX3-Clips aus Sortiert/Interviews/ und Sortiert/Scriptet/ beider Standorte
(ohne B-Roll, Actioncam, Mavic, a7MK4 — die a7MK4 ist parallele B-Cam derselben
Takes, FX3 ist Ton-/Timecode-Referenz). Originale werden nur gelesen.
"""
...
SCAN_DIRS = [
    "Standort 1/Sortiert/Interviews", "Standort 1/Sortiert/Scriptet",
...
def collect() -> list[dict]:
    ...
    for rel in SCAN_DIRS:
        ...
        for p in sorted(base.rglob("FX3_*.MP4")):
            ...
            # ("Standort 1", "Sortiert", "Interviews", "<Person>", "FX3_x.MP4")
            # ("Standort 1", "Sortiert", "Scriptet", "FX3_x.MP4")
