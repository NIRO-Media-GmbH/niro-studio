// SFX-Minimalkit synthetisieren — 16-bit-Mono-WAVs, keine externen Assets, deterministisch.
// Ausgabe: public/sfx/ (whoosh, pop, thump, pad, …) — per staticFile("sfx/<name>.wav") in <Audio> nutzen.
// Aufruf: npm run sfx   (WAVs sind gitignored und werden bei Bedarf neu erzeugt)
// Quelle: github.com/haidrrrry/claude-remotion-skill examples/scripts/gen-sfx.mjs (MIT), übernommen 19.09.2026.
