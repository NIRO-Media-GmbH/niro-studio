...
// 9:16 portrait-4k (2160×3840), 25fps, 80.16s
// ============================================================
...
export const imagefilmOverlaySchema = projectPropsSchema.extend({
...
export type ImagefilmOverlayProps = z.infer<typeof imagefilmOverlaySchema>;

// --- Default Props ---

export const imagefilmOverlayDefaults: ImagefilmOverlayProps = {
  format: "portrait-4k" as const,
  fps: 25 as const,
  durationInSeconds: 80.16,
  transparent: true,
  review: {
    showGuides: false,
    showSafeZone: true,
...
export const BremsenSchneiderImagefilm: React.FC<ImagefilmOverlayProps> = ({
  review,
  keywords,
  infoPanels,
  endCard,
