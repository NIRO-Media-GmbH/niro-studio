...
// talking-head reel. 1080×1920, 25fps, ~45s.
// Graphics CENTERED, placed in the reels safe band.
// ============================================================
...
export const reel2Schema = projectPropsSchema.extend({
  timeOffsetSec: z
    .number()
    .step(0.1)
...
export type Reel2Props = z.infer<typeof reel2Schema>;

// --- Default Props ---

export const reel2Defaults: Reel2Props = {
...
export const SauberEntsorgenReel2: React.FC<Reel2Props> = ({
  review,
  timeOffsetSec,
}) => {
