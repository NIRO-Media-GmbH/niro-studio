...
export interface MarkerHighlightProps {
  ...
  speed?: number;
  className?: string;
  /** NIRO: Root-Hintergrund; Standard transparent statt weiß (Alpha-Overlays, dunkle Szenen). */
  background?: string;
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* NIRO: Folgetext über dem Marker, sonst malt der Spring-Overshoot über die ersten Buchstaben */}
        <span style={{ position: "relative", zIndex: 1 }}>{after}</span>
      </span>
    </div>
  );
}
