// ============================================================
// NIRO Motion Graphics — Component Library
// All reusable animation components in one barrel export
// ============================================================

// Text
export { FadeInText } from "./text/FadeInText";
...
// Backgrounds
export { GradientBackground } from "./backgrounds/GradientBackground";
export { ParticleField } from "./backgrounds/ParticleField";
export { NoiseBackground } from "./backgrounds/NoiseBackground";
export { WaveBackground } from "./backgrounds/WaveBackground";
