...
// 9:16 portrait-4k (2160×3840), 25fps, 50.24s
// ============================================================
...
export const azubiOverlaySchema = projectPropsSchema.extend({
...
export type AzubiOverlayProps = z.infer<typeof azubiOverlaySchema>;

// --- Default Props ---

export const azubiOverlayDefaults: AzubiOverlayProps = {
  format: "portrait-4k" as const,
  fps: 25 as const,
  durationInSeconds: 50.24,
  transparent: true,
  review: {
    showGuides: false,
    showSafeZone: true,
...
export const BremsenSchneiderAzubi: React.FC<AzubiOverlayProps> = ({
  review,
  keywords,
  infoPanels,
  endCard,
