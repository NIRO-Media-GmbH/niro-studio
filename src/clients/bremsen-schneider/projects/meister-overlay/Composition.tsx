...
// 9:16 portrait-4k (2160×3840), 25fps, 73.84s
// ============================================================
...
export const meisterOverlaySchema = projectPropsSchema.extend({
...
export type MeisterOverlayProps = z.infer<typeof meisterOverlaySchema>;

// --- Default Props ---

export const meisterOverlayDefaults: MeisterOverlayProps = {
  format: "portrait-4k" as const,
  fps: 25 as const,
  durationInSeconds: 73.84,
  transparent: true,
  review: {
    showGuides: false,
    showSafeZone: true,
...
export const BremsenSchneiderMeister: React.FC<MeisterOverlayProps> = ({
  review,
  keywords,
  infoPanels,
  endCard,
