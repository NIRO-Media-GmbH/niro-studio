...
// 3 Tipps mit Nummer, Titel und Untertitel
// ============================================================
...
export const dreiTippsSchema = projectPropsSchema.extend({
  steps: z.array(stepSchema).describe("Tipps"),
});

export type DreiTippsProps = z.infer<typeof dreiTippsSchema>;

export const dreiTippsDefaults: DreiTippsProps = {
...
export const TopFotografieDreiTipps: React.FC<DreiTippsProps> = ({
  review,
  steps,
}) => {
