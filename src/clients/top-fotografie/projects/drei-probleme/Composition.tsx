...
export const dreiProblemeSchema = projectPropsSchema.extend({
  steps: z.array(stepSchema).describe("Probleme"),
});

export type DreiProblemeProps = z.infer<typeof dreiProblemeSchema>;

export const dreiProblemeDefaults: DreiProblemeProps = {
...
export const TopFotografieDreiProbleme: React.FC<DreiProblemeProps> = ({
  review,
  steps,
}) => {
      ...
      <AbsoluteFill>
        {steps.map((step, i) => (
          <Sequence
            ...
            name={`Problem ${step.num}: ${step.title}`}
          >
